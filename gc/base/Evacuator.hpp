...
private:
	...
	MM_EvacuatorScanspace *_scanStackFrame;			/* active stack frame at current stack position, NULL if scan stack empty (== _whiteStackFrame unless popping) */
...
private:
	...
	MMINLINE void setStackRegion(EvacuationRegion workRegion);
